...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col">
                    <a href="#" data-toggle="popover" title="Info on Context Base Search" data-content="To use the search bar select the type of information being searched and enter the exact value. The search is Case-Sensitive !">Events Overview</a>
