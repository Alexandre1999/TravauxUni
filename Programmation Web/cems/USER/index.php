        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="index.php"><i class="fas fa-user-check"></i><span>Attendance</span></a></li>
            ...
            <div class="container-fluid">
                    ...
                    if(isset($_GET['error'])) {
                        if ($_GET["error"] == "emptyfield") {
                            echo '<div class="alert alert-warning"><a href="#" class="close" data-dismiss="alert">&times;</a> <strong>Warning!</strong> Fill in the required fields</div>';
                        }

                        if ($_GET['error'] == "success"){
                            echo '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert">&times;</a> <strong>Success!</strong>     <i class="far fa-thumbs-up"></i></div>';
                        }

                        if ($_GET['error'] == "failed"){
                            echo '<div class="alert alert-warning"><a href="#" class="close" data-dismiss="alert">&times;</a> <strong>Warning!</strong> Failed</div>';
                        }

                        if ($_GET['error'] == "wrongval"){
                            echo '<div class="alert alert-warning"><a href="#" class="close" data-dismiss="alert">&times;</a> <strong>Warning!</strong> Enter a valid eid</div>';
                        }

                        if ($_GET['error'] == "wrnginput"){
                            echo '<div class="alert alert-warning"><a href="#" class="close" data-dismiss="alert">&times;</a> <strong>Warning!</strong> Enter a valid name and surname</div>';
                        }
                ...
                <p>Select event for attendance</p>
                    ...
                    <div class="col">
                        <div>
                            ...
                            <form action="../php/userpoint.php" method="post">
                                <div class="form-row">
                                    <div class="col-auto" style="margin-right: 5px;"><input class="form-control" type="text" placeholder="Enter eid" name="usereid" style="width: 171px;"></div>
                                    <div class="col-auto text-center"><button class="btn btn-primary" type="submit" name="usereventsearch">Search</button></div>
                                </div>
                            </form>
