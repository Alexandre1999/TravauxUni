                    ...
                    <div class="col">
                        ...
                        <div>
                            <div class="table-responsive">
                                ...
                                <div class="form-row">
                                    <div class="col-auto" style="margin-right: 5px; margin-bottom: 10px;"><input class="form-control" id="picker" type="text" placeholder="Enter Date & Time" name="userdate"></div>
                                ...
                                <div class="form-row">
                                    <div class="col-auto" style="margin-right: 5px;"><input name="username" class="form-control" type="text" placeholder="Enter Name"></div>
                                    <div class="col-auto" style="margin-right: 5px;"><input name="usersurname" class="form-control" type="text" placeholder="Enter Surname"></div>
                                    <div class="col-auto text-center" style="margin-right: 6px;"><input name="usertid" class="form-control" type="text" placeholder="Enter ID Type"></div>
                                    <div class="col-auto text-center" style="margin-right: 6px;"><input name="useridval" class="form-control" type="text" placeholder="Enter ID Value"></div>
                                    <div class="col-auto text-center"><button name="personadd" class="btn btn-primary" type="submit">Add</button></div>
                                </div>
